"""Models module, definitive source of information about the data.
It contains the essential fields and behaviors of the data stored.
...
class UserProfile(models.Model):
    ...
    show_comments = models.BooleanField(verbose_name=_('Show exercise ' +
                                                       'comments'),
                                        help_text=_('Check to show' +
                                                    ' exercise comments on the'
                                                    ' workout view'),
                                        default=True)
    '''
    ...
    # (obviously this is only meaningful if the user has a language other
    # than english)
...
difficult.'''),
    ...
    workout_reminder_active = models.BooleanField(verbose_name=_('Activate' +
                                                                 ' workout' +
                                                                 ' reminders'),
                                                  help_text=_('Check to ' +
                                                              'activate ' +
                                                              'automatic '
                                                              'reminders' +
                                                              ' for ' +
    ...
    workout_duration = IntegerField(verbose_name=_('Default duration of ' +
                                                   'workouts'),
                                    help_text=_('Default duration in weeks ' +
                                                'of workouts not '
                                                'in a schedule. Used for' +
                                                ' email workout '
                                                'reminders.'),
                                    default=12,
                                    validators=[MinValueValidator(1),
    ...
    timer_active = models.BooleanField(verbose_name=_('Use pauses in' +
                                                      ' workout timer'),
                                       help_text=_('Check to activate' +
                                                   ' timer pauses between '
                                                   'exercises.'),
                                       default=True)
    '''
    ...
    ro_access = models.BooleanField(verbose_name=_('Allow external access'),
                                    help_text=_('Allow external users to' +
                                                ' access your workouts and '
...
class License(models.Model):
    ...
    full_name = models.\
        CharField(max_length=60,
                  ...
                  help_text=_('If a license has been localized, e.g. the  '
                              'Creative Commons licenses for the different  '
