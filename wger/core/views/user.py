...
def fitbit_authorisation(request, code=None):
    ...
    '''
    template_data = {}
    client_id = os.get_env('FITBIT_CLIENT_ID')
    client_secret = os.get_env('FITBIT_SECRET')
    ...
    if 'code' in request.GET:
        ...
        form = {
            ...
            'redirect_uri': 'http://127.0.0.1:8000/en/weight/overview/'
        }
        headers = {
