        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workout_reminder_active', models.BooleanField(
                    default=False,
                    help_text='Check to ' + 'activate automatic reminders for'
                ...
                ('workout_reminder', models.IntegerField(
                    default=14,
                    help_text='The number' + ' of days you want to be reminded'
                ...
                ('workout_duration', models.IntegerField(
                    default=12,
                    help_text='Default duration in weeks of' +
                ...
                ('timer_active', models.BooleanField(
                    default=True,
                    help_text='Check to activate timer pauses' +
                    ' between exercises.',
