...
class Gym(m.Model):
    ...
    class Meta:
        permissions = (("gym_trainer",
                        _("Trainer: can see the users for a gym")),
                       ("manage_gym", _("Admin: can manage users for a gym")),
                       ("manage_gyms",
                        _("Admin: can administrate the different gyms")), )
        ordering = [
            "name",
        ]
...
class Contract(m.Model):
    ...
    AMOUNT_TYPE = ((AMOUNT_TYPE_YEARLY, _("Yearly")), (AMOUNT_TYPE_HALFYEARLY,
                                                       _('Half yearly')),
                   (AMOUNT_TYPE_MONTHLY, _('Monthly')), (AMOUNT_TYPE_BIWEEKLY,
                                                         _('Biweekly')),
                   (AMOUNT_TYPE_WEEKLY, _('Weekly')), (AMOUNT_TYPE_DAILY,
                                                       _('Daily')), )
