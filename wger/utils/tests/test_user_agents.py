...
class AmazonUserAgentTestCase(WorkoutManagerTestCase):
    ...
    def test_user_agent_3rd_generation(self):
        ...
        agent = "Mozilla/5.0 (Linux; Android 4.2.2; <device> Build/<build>)"\
                "AppleWebKit/ "\
    ...
    def test_user_agent_2nd_generation(self):
        ...
        agent = "Mozilla/5.0 (Linux; Android 4.0.3;"\
                ...
                "Mobile Safari/<safari> AmazonWebAppPlatform"\
                "/<version>"
        self.assertTrue(user_agents.is_amazon_webview(agent))
    ...
    def test_user_agent_1st_generation(self):
        ...
        agent = "Mozilla/5.0 (Linux; U; Android 2.3.4; <locale>;"\
                ...
                "AppleWebKit/<webkit> (KHTML, like Gecko) Version/4.0" \
                "Safari/<safari> "\
                "AmazonWebAppPlatform/<version> "
        self.assertTrue(user_agents.is_amazon_webview(agent))
...
class AndroidUserAgentTestCase(WorkoutManagerTestCase):
    ...
    def test_user_agent_new_ua(self):
        ...
        agent = "Mozilla/5.0 (Linux; Android 4.4; Nexus 5 Build/BuildID)"\
                " AppleWebKit/537.36 "\
                "(KHTML, like Gecko) Version/4.0 Chrome/30.0.0.0 Mobile"\
                " Safari/537.36 "\
                "WgerAndroidWebApp"
        self.assertTrue(user_agents.is_android_webview(agent))
