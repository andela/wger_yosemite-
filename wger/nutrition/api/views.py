...
class IngredientViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_values(self, request, pk):
        ...
        This function basically just performs a multiplication
        (in the model), and is a candidate to be moved to pure AJAX calls,
        however doing it like this keeps the logic nicely hidden and respects
        the DRY principle.
        '''
...
class NutritionPlanViewSet(viewsets.ModelViewSet):
    ...
    def nutritional_values(self, request, pk):
        ...
        '''
        return Response(NutritionPlan.
                        objects.get(pk=pk).get_nutritional_values())
