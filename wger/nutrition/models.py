...
class Ingredient(AbstractLicenseModel, models.Model):
    ...
    INGREDIENT_STATUS = ((INGREDIENT_STATUS_PENDING,
                          _('Pending')), (INGREDIENT_STATUS_ACCEPTED,
                                          _('Accepted')),
                         (INGREDIENT_STATUS_DECLINED,
                          _('Declined')), (INGREDIENT_STATUS_ADMIN,
                                           _('Submitted by administrator')),
