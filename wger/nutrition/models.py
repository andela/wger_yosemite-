...
class NutritionPlan(models.Model):
    ...
    description = models.\
        TextField(max_length=2000,
                  blank=True,
                  verbose_name=_('Description'),
                  help_text=_('A description of the goal of the plan, e.g. '
                              '"Gain mass" or "Prepare for summer"'))
    has_goal_calories = models.\
        BooleanField(verbose_name=_('Use daily calories'),
                     default=False,
    ...
    def get_closest_weight_entry(self):
        ...
        if abs(closest_entry_gte.date - target) < abs(closest_entry_lte.
                                                      date - target):
...
class IngredientWeightUnit(models.Model):
    ...
    amount = models.DecimalField(decimal_places=2,
                                 ...
                                 help_text=_('Unit amount, '
                                             'e.g. "1 Cup" or "1/2 spoon"'))
