...
def view(request):
    ...
    context['form_activities'] = PhysicalActivitiesForm(instance=request.
                                                        user.userprofile)
    context['form_calories'] = DailyCaloriesForm(instance=request.
                                                 user.userprofile)
...
def calculate_activities(request):
    ...
    if form.is_valid():
        ...
        total = request.user.userprofile.\
            calculate_basal_metabolic_rate() * factor
