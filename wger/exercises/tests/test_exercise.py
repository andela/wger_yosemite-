...
class ExerciseIndexTestCase(WorkoutManagerTestCase):
    ...
    def test_exercise_index_logged_out(self):
        '''
        Tests the exercise overview page as
        an anonymous (logged out) user
        '''
...
class ExerciseDetailTestCase(WorkoutManagerTestCase):
    ...
    def test_exercise_detail_logged_out(self):
        '''
        Tests the exercise details page as an
...
class ExercisesTestCase(WorkoutManagerTestCase):
    ...
    def add_exercise_user_fail(self):
        '''
        Helper function to test adding
         exercises by users that aren't
         authorized
        '''
    ...
    def add_exercise_success(self, admin=False):
        '''
        Tests adding/editing an exercise with a
        user with enough rights to do this
        '''
    ...
    def test_add_exercise_success(self):
        '''
        Tests adding/editing an exercise with a user
        with enough rights to do this
        '''
        self.user_login('admin')
    ...
    def test_add_exercise_user_no_rights(self):
        '''
        Tests adding an exercise with a user without
...
class ExercisesCacheTestCase(WorkoutManagerTestCase):
    ...
    def test_exercise_overview(self):
        '''
        Test the exercise overview cache is
         correctly generated on visit
        '''
        if self.is_mobile:
    ...
    def test_exercise_detail(self):
        '''
        Test that the exercise detail
         cache is correctly generated on visit
        '''
    ...
    def test_overview_cache_update(self):
        ...
        old_exercise_overview_mobile = cache.get(get_template_cache_name
