...
class ExerciseCategoryRepresentationTestCase(WorkoutManagerTestCase):
    ...
    def test_representation(self):
        ...
        '''
        self.assertEqual("{0}".format(ExerciseCategory
                                      .objects.get(pk=1)), 'Category')
...
class ExerciseCategoryCacheTestCase(WorkoutManagerTestCase):
    ...
    def test_overview_cache_update(self):
        ...
        old_exercise_overview = cache.get(get_template_cache_name
                                          ('exercise-overview', 2))
        ...
        if not self.is_mobile:
            self.assertNotEqual(old_exercise_overview,
                                new_exercise_overview)
        else:
