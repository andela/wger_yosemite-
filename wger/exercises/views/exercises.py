...
class ExercisesEditAddView(WgerFormMixin):
    ...
    def get_form_class(self):
        ...
        # Define the exercise form here because only at
...
class ExerciseCorrectView(ExercisesEditAddView,
    ...
    messages = _('Thank you. Once the changes are\
    ...
    def form_valid(self, form):
        ...
        We don't return the super().form_valid
        because we don't want the data
        to be saved.
        '''
        subject = 'Correction submitted for\
         exercise #{0}'.format(self.get_object().pk)
        context = {
...
class ExerciseDeleteView(WgerDeleteMixin,
    ...
    delete_message = ugettext_lazy('This will delete the \
     exercise from all workouts.')
...
class PendingExerciseListView(LoginRequiredMixin,
    ...
    def get_queryset(self):
        ...
        '''
        return Exercise.objects.pending().order_by
        ('-creation_date')
...
def accept(request, pk):
    '''
    Accepts a pending user submitted
    exercise and emails the user, if possible
    '''
