    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(
                    ...
                    ' schedule as your active one (will be shown e.g. on ' +
                    'your dashboard). All other schedules will then' +
                    ' be marked as inactive',
                    verbose_name='Schedule active')),
                ('is_loop', models.BooleanField(
                    default=False,
                    help_text='Tick the box if you want to repeat the '
                    'schedules in a loop (i.e. A, B, C, A, B, C, and so on)',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(
                    help_text="A short description or goal of the workout. "
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(
                    help_text='Any notes you might want to save about'
