...
@task(help={'address': 'Address to bind to. Default: localhost',
            ...
            ' Default: false',
            'settings-path': 'Path to settings file (absolute path'
...
@task(help={'settings-path': 'Path to settings file (absolute path'
            ...
            'port': 'Port to use. Default: 8000',
            'browser': 'Whether to open the application in a browser'
...
def create_settings(context, settings_path=None,
                    database_path=None, url=None,
    ...
    settings_template = os.path.join(os.path.dirname(os.path.abspath
                                                     (__file__)), 'wger',
                                     'settings.tpl')
...
def config_location(context):
    ...
    print('* settings:      {0}'.format(get_user_config_path('wger',
                                                             'settings.py')))
    print('* media folder:  {0}'.format(get_user_data_path('wger', 'media')))
    print('* database path: {0}'.format(get_user_data_path('wger',
                                                           'database.sqlite')))
